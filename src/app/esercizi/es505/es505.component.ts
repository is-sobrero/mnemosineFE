...
export class Es505Component {
  ...
  ngOnInit() {
    ...
    switch (this.level) {
      ...
      case 2:
        this.connection
          .get('assets/exAssets/dizionario_immagini/dizionario_medio.txt', {
            responseType: 'text',
          })
          .subscribe((data) => {
            this.dictionary = data.split('\n');
  ...
  checkContent(dummy_index: number) {
    ...
    if (
      this.dummy_container[dummy_index].quarter == this.quarter &&
      this.image_link == this.dummy_container[dummy_index].link
    ) {
  ...
  setImage() {
    ...
    for (var i = 0; i < this.dummy_container.length; i += 1) {
      ...
      cached_dummy = new DummyObject(
        '' + this.list_of_words.at(i),
        dummy_quarter,
      );
    ...
    switch (this.quarter) {
      case 1:
        cover.style =
          'display:block; transform: translate(0px, -304px); width:150px;height:150px; background-color:black;';
        break;
      case 2:
        cover.style =
          'display:block; transform:translate(150px,-304px); width:150px;height:150px; background-color:black;';
        break;
      case 3:
        cover.style =
          'display:block; transform:translate(0px,-154px); width:150px;height:150px; background-color:black;';
        break;
      case 4:
        cover.style =
          'display:block; transform:translate(150px,-154px); width:150px;height:150px; background-color:black;';
        break;
    }
...
class DummyObject {
  ...
  setGraphics(): void {
    switch (this.quarter) {
      case 1:
        this.obj.style =
          'transform-origin:top left;transform:translate(0px, 0px)';
        break;
      case 2:
        this.obj.style =
          'transform-origin:top right;transform:translate(-50%, 0%)';
        break;
      case 3:
        this.obj.style =
          'transform-origin:bottom right;transform:translate(0%, -50%) ';
        break;
      case 4:
        this.obj.style =
          'transform-origin:bottom left;transform:translate(-50%, -50%) ';
        break;
      default:
