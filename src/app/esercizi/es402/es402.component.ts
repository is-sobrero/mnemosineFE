...
export class Es402Component implements OnInit {
  ...
  private base_link: string =
    'https://res.cloudinary.com/djjwizrmr/video/upload/v1725207724/mnemosine/audio_402/';

  private container: any = null;
  private container_full: any = null;
  ...
  ngOnInit() {
    ...
    this.connection
      ...
      .subscribe((data) => {
        ...
        this.container = document.querySelector('.word_container');

        this.container_full = document.querySelector('.word_container_full');

        this.container.innerHTML = '';
        this.container_full.innerHTML = '';
  ...
  checkContent() {
    if (this.display.toLowerCase() == this.word_typed.toLowerCase()) {
      ...
      this.ES.nextExercise(402, { errors: this.errors, time: this.timeMillis });
    } else {
      this.errors += 1;
  ...
  setWord(): void {
    ...
    var cell_style: string =
      'padding:15px!important;margin:5px!important;margin-left:10px!important;margin-right:10px!important;border: 3px solid #383838!important;border-radius: 5px!important;width: min-content!important;height: min-content!important;filter: drop-shadow(0 4px 3px rgb(0 0 0 / 0.07)) drop-shadow(0 2px 2px rgb(0 0 0 / 0.06));';
    var obj_style: string =
      'display: flex!important;flex-direction: row!important;justify-content: center!important;align-content: center!important;margin-top:40px!important;margin-bottom:30px!important;';
    ...
    */
    ...
    this.container_full.appendChild(obj_2);
